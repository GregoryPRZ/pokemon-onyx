...
extern const u8 gText_PerfectIvsOff[];
extern const u8 gText_PerfectIvsOn[];
extern const u8 gText_EvsYieldOff[];
extern const u8 gText_EvsYieldOn[];
...
extern const u8 gText_Perfect_Ivs[];
extern const u8 gText_Evs_Yield[];
