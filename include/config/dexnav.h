...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x883 // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x882 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x885 // Allow player to find hidden mons
#define DN_VAR_SPECIES                0x40F9 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           0x40FA // Steps for finding hidden pokemon
