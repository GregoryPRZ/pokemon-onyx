...
// Flag/var defines
#define DN_FLAG_SEARCHING             264 // Searching for mon
#define DN_FLAG_DEXNAV_GET            265 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         266 // Allow player to find hidden mons
#define DN_VAR_SPECIES                267 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           268 // Steps for finding hidden pokemon
