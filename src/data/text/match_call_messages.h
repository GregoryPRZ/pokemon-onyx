...
const u8 gText_MatchCallChampion_Steven_Strategy[] = _("Ancestral power.");
const u8 gText_MatchCallChampion_Steven_Pokemon[] = _("I use ancient POKéMON.");
const u8 gText_MatchCallChampion_Steven_Intro1[] = _("I study and collect all");
const u8 gText_MatchCallChampion_Steven_Intro2[] = _("kinds of stones.");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_STEVEN_CHAMPION] = MCFLAVOR(Champion_Steven),
};
