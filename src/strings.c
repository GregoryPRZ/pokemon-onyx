...
const u8 gText_Damage_Numbers[] = _("DAMAGE");
const u8 gText_Stat_Editor[] = _("STAT EDITOR");
const u8 gText_Font_Type[] = _("FONT TYPE");
...
const u8 gText_BattleSceneNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}x1");
const u8 gText_BattleSceneFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}x2");
const u8 gText_BattleSceneFaster[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}x3");
const u8 gText_BattleSceneFastest[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}x4");
...
const u8 gText_FontEmerald[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}RSE");
