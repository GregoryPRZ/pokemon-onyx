...
const u8 gText_Gen4Voice[] = _("Music Style");
...
const u8 gText_Gen4VoiceClassic[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Classic");
const u8 gText_Gen4VoiceModern[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Modern");
const u8 gText_DPPtMusic[] = _("Soundtrack");
const u8 gText_DPPtMusicRSE[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}RSE/FRLG");
const u8 gText_DPPtMusicDPPt[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}DPPt");
