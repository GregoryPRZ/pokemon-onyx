...
static void PrintMonStats()
{
    ...
    u8 abilityIndex = gSpeciesInfo[sStatEditorDataPtr->speciesID].abilities[GetMonData(ReturnPartyMon(), MON_DATA_ABILITY_NUM)];
    StringCopy(gStringVar2, gAbilityNames(abilityIndex));
